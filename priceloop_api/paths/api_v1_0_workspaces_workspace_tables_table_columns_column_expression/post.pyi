...
SchemaFor200ResponseBodyApplicationJsonCharsetUTF8 = ApiColumn
...
class AddFormulaColumn(BaseApi):
    ...
    def add_formula_column(
        ...
        return self._add_formula_column_oapg(
            body=body,
